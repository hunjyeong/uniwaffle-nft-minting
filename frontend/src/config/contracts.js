...
export const COMPOSABLE_ABI = [
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "enum ComposableNFT.NFTType",
        "name": "nftType",
        "type": "uint8"
      },
      {
